...
async function generateModuleGroupTable(
  ...
  for (const module of modules) {
    ...
    const versionListUrl = `https://${registry}/v2/bicep/${module.moduleName}/tags/list`;
    const versionBadgeUrl = `https://img.shields.io/badge/bh-${latestVersion}-blue`;
    ...
    const moduleRootUrl = `https://github.com/${repo}/tree/main/modules/${module.moduleName}`;
 ...
 * @param {Params} params
 */
async function generateModuleIndexMarkdown({
  require,
  github,
  context,
  core,
